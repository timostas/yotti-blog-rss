...
export function createArticleHtml(configInput, article) {
  ...
  return [
    ...
    "    img,svg{max-width:100%;height:auto}.article-cover{margin:32px 0 44px}.yotti-information-graphic{margin:28px 0}.article-cover img,main>figure img,.yotti-photo img{display:block;width:100%;border-radius:24px}figcaption{margin:.75rem auto 0;max-width:92%;color:var(--muted);font-size:.88rem;line-height:1.5;text-align:center;font-style:italic}",
